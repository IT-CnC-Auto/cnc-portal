      ...
      <div className="bg-white rounded-2xl shadow-cnc-md border border-cnc-gray-100 p-8">
        ...
        <form action="/dashboard" method="get" className="space-y-5">
          <div>
            <label
              htmlFor="email"
              className="block text-sm font-medium text-cnc-gray-700 mb-1.5"
            >
              Email address
            </label>
            <input
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label
                htmlFor="password"
                className="block text-sm font-medium text-cnc-gray-700"
              >
                Password
              </label>
              <a
                href="#"
                className="text-xs text-cnc-red hover:text-cnc-red-dark font-medium transition-colors"
              >
                Forgot password?
              </a>
            </div>
          ...
          <div className="flex items-center gap-2">
            <input
              type="checkbox"
              id="remember"
              className="w-4 h-4 rounded border-cnc-gray-300 accent-cnc-red"
            />
          ...
          <button
            type="submit"
            className="w-full py-2.5 px-4 bg-cnc-red hover:bg-cnc-red-dark text-white font-heading font-semibold text-sm rounded-lg shadow-cnc-red transition-colors duration-200 mt-1"
          >
            Sign In
          </button>
        </form>
        ...
        <p className="text-xs text-cnc-gray-400 text-center">
          Need access?{' '}
          <a
            href="mailto:it@carenetconsultants.co.za"
            className="text-cnc-red hover:underline"
          >
            Contact IT
          </a>
        </p>
